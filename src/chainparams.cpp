...
public:
    CMainParams() {
		...
		vSeeds.push_back(CDNSSeedData("5",  "202.182.110.45"));
		vSeeds.push_back(CDNSSeedData("6",  "204.48.29.203"));//Olympicseednode1
		vSeeds.push_back(CDNSSeedData("7",  "204.48.29.196"));//Olympicseednode2
		vSeeds.push_back(CDNSSeedData("8",  "159.89.142.84"));//Olympicseednode3
		vSeeds.push_back(CDNSSeedData("9",  "206.189.216.140"));//Olympicseednode4
		vSeeds.push_back(CDNSSeedData("10",  "159.65.203.132"));//Olympicseednode5
		vSeeds.push_back(CDNSSeedData("11",  "167.99.219.245"));//Olympicseednode6
		vSeeds.push_back(CDNSSeedData("12",  "128.199.198.218"));//Olympicseednode7
		vSeeds.push_back(CDNSSeedData("13",  "128.199.231.169"));//Olympicseednode8
		vSeeds.push_back(CDNSSeedData("14",  "206.189.61.199"));//Olympicseednode9
		vSeeds.push_back(CDNSSeedData("15",  "206.189.61.202"));//Olympicseednode10
